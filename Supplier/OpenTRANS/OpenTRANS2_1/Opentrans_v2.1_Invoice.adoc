...
Parties
^^^^^^
Required parties are SUPPLIER and PAYER.
...
| PARTY_ROLE     | Identifies the role of this party   | payer
...
| gln                  | optional             | preferred for payer
| supplier_specific    | ID of payer party    | mandatory for payer
| buyer_specific       | ID of supplier party | mandatory for supplier
|========================================================================
...
| payer             | Buyers Address    | mandatory
...
| TAX_DETAILS_FIX | Product name        | <<TaxDetailsFix>>
|=======================================================================
...
| NET_VALUE_GOODS   | Count of line items  | 287.56
| TOTAL_AMOUNT      | Count of line items  | 309.7
| TOTAL_TAX         | Count of line items  | <<TotalTax>>
|=====================================================
