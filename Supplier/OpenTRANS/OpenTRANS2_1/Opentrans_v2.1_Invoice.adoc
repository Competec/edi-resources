...
Party Identifiers
^^^^^^^^^^^^^^^^^^
All parties should be identified by their gln. If this is not possible, the supplier/invoice issuing party must be identified by competec internal ID.

[width="100%",options="header"]
|========================================================================
| type                 | Description          | Remarks
| gln                  | optional             | preferred
| supplier_specific    | ID of buying party   | only for buyer if no gln
