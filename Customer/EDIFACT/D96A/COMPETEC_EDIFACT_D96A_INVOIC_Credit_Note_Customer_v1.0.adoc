...
|1.3       |22.10.2025 |Update mapping definitions  |SEBR
|===
...
|*Pos*      |*Segment/Element* |*Description*        |*Status* |*Example* |*Remarks*
.2+|010 .2+^|3035 |Party qualifier                   |#M#    m|+RE |
4+|                 *_Supported codes:_* +
                 #RE = Payment Receiver# +
                 #SU = Supplier# +
                 IV = Invoicee +
...
^|          3039 |Party id. identification          |M       m|+7609999111111 |gln or internal customer ID
...
.2+^|        1154 |Reference number            |C       m|:CHE-191.398.369 MWST |
|===
...
LIN+1'
PIA+5+1943069:SA'
IMD+F++:::Electrolux Fensterdichtungssatz EWKIT5::DE'
QTY+47:1:PCE'
----
| SG26
...
----
LIN+2'
IMD+F++:::Bearbeitungsgebühr/Geöffnet::DE'
QTY+47:-1:PCE'
----
| SG26
...
----
LIN+3'
IMD+F++:::Der Artikel konnte von uns nicht mehr::DE'
LIN+4'
IMD+F++:::als Neuware gebucht werden, daher wurde::DE'
LIN+5'
IMD+F++:::der Artikel als geöffnete Ware verbucht.::DE'
LIN+6'
IMD+F++:::Danke für Ihr Verständnis.::DE'
----
| SG26
